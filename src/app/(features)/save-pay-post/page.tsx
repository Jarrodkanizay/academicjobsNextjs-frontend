...
export const metadata: Metadata = {
  title: 'Post a job employer or recruiter', //Option 1 replaces the %s in layout.tsx
  // title: {//
...
const PostJobPage = () => {
  return <JobPostForm partner="Post My Job" region="USA" />; //Leave this blank for AcademicJobs
};
