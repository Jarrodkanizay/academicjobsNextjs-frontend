          ...
          <div className="w-full md:w-3/5 h-[60vh] flex flex-col items-top max-w-screen-md mx-auto">
            ...
            >
              <div className="flex flex-col  gap-2 md:flex-row md:gap-0 mx-18 w-full  mt-5 md:border rounded-full p-2 md:shadow-md ">
                ...
                />
                <button
                  className="px-4 py-2 bg-[#f4a10c] text-white rounded-full shadow-md hover:bg-gradient-to-t from-white via-amber-500 to-amber-500 font-bold animate-pulse"
                  type="submit"
                >
              ...
              <button
                className="pr-7  font-bold text-gray-400 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-l from-green-500 via-green-500 to-sky-500 "
                // onClick={() => {
                //   const a = {};
          ...
          <div className="max-w-screen-xl mx-auto">
            ...
            <p className="px-7 mb-4"></p> */}
              ...
              <p className="px-7">
                ...
                the most current opportunities in academia globally. Connect
                with your next career move in the academic sector through our
                  ...
                  <div className="column">
                    <ul className="">
                      <li className="mb-1 mt-4 hover:underline">
                        ...
                        >
                          Assistant Professor in Pasifika Theater and
                          Performance Studies, UCLA
                        </Link>
                      </li>
