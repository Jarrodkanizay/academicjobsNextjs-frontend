...
export const metadata: Metadata = {
  title: {
    absolute: 'Academic Jobs Recruitment', //Option 2 overrides the title in layout.tsx
  },
  description:
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
          ...
          <div className="card bg-slate-100 shadow-xl">
            ...
            <div className="card-body items-left text-left">
              <h2 className="card-title">Global Leading Academic Job Board</h2>
              <p>
                ...
                <span className="hidden">
                  We specialize in matching premier academic professionals with
      ...
      <div className="bg-teal-100 mb-8 mt-16 py-8 px-4">
        <div className="container mx-auto">
          ...
          <div className="text-col-2">
            ...
            <p className="mb-4">
              Our platform is designed to minimize your job listing costs while
