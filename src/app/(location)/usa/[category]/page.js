...
import usapositionsData from "@/data/usapositions.json";
...
export default function Page({ params, searchParams }) {
  ...
  const {
    ...
    Keyword,
    content: content1,
  } = usapositionsData.find((item) => item.Name === category);
  let content;
  //console.log(Name);
  ...
  content = (
    <div className="content-grid flex-col gap-2">
      ...
      {/* <Link className="text-[#f4a10c] " href="/usapositions/">
