  ...
  return (
    <main>
      ...
      <section className="container mx-auto px-4">
        <PricingTable2 currency={'USD'} hideRegionSelector={true} />
      </section>
      ...
      <section className="container mx-auto px-4 mt-12">
        ...
        <h2 className="text-center mb-4">
          Connect with {countryRegionPlural()} Academic Elite on the Premier Job
          Board
        </h2>
        <div className="text-col-2">
          <p className="max-w-xl mx-auto">
            Leverage the power of {countryRegionPlural()} No. 1 Academic Job
            Board for unparalleled access to top-tier academic talent. Academic
            Jobs simplifies your recruitment process, offering an affordable,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
          ...
          <div className="card bg-slate-100 shadow-xl">
            ...
            <div className="card-body items-center text-center">
              ...
              <p>
                Connect with {countryRegionPlural()} top academic talent on the
                nation's No. 1 Academic Job Board. Posting jobs is simple and
      ...
      <div className="bg-sky-100 mb-8 mt-16 py-8 px-4">
        <div className="container mx-auto">
          ...
          <p className="mb-4 text-center max-w-[500px] mx-auto">
            Academic Jobs doesn't just find academics, we specialize in finding
          ...
          <div className="card bg-slate-100 shadow-xl">
            ...
            <div className="card-body items-center text-center">
              ...
              <p>
                ...
                extensive network of elite university professionals, Chancellors
                & Presidents to executive management teams.
              </p>
            </div>
          </div>
        ...
        <div className="card card-side bg-slate-100 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="card-body w-full">
            ...
            <p className="max-w-screen-sm">
              ...
              who will join your organization.
            </p>
            <div className="card-actions justify-end">
        ...
        <div className="container mx-auto">
          ...
          <div className="text-col-2">
            <p className="mb-4">
              ...
              affordability, and unparalleled access to a global talent pool. As
              the premier destination for academic recruitment, we cater
            ...
            <p className="mb-4">
              ...
              maximizing results and recruiter satisfaction. With access to our
