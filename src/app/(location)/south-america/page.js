...
export const metadata = {
  ...
  keywords:
    'Academic Jobs South America. academic job in  South America ,  South America  university jobs',
};
      ...
      <div className="content-grid mx-auto">
          ...
          <div className="md:hero-content flex-col lg:flex-row mx-auto md:items-start py-12  ">
            ...
            <div>
              <p className="px-7 mb-4 mt-1">
                ...
                academic job, anywhere in the world. Academic Jobs provides an
        ...
        <div>
          <h2 className="underline-full">
            AcademicJobs South America: All University Jobs by Country{' '}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
            <ul>
              <li className="mb-1 ">
                <Link href="/jobs/brazil/" className="text-[#f4a10c] font-bold">
                  Brazil
                </Link>
              </li>
              <li>
            ...
            <ul>
              <li className="mb-1 ">
                <Link href="/jobs/chile/" className="text-[#f4a10c] font-bold">
                  Chile
                </Link>
              </li>
              <li>
            ...
            <ul>
              <li className="mb-1 ">
                <Link href="/jobs/peru/" className="text-[#f4a10c] font-bold">
                  Peru
                </Link>
              </li>
              <li>
