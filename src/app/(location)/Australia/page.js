  ...
  return (
    <div>
      ...
      <div className=" mt-[10rem] " >
        <ul className="faculty-container flex flex-wrap gap-4 items-center justify-center text-gray-400 ">
          <ul className="w-full  md:w-auto flex items-center  justify-center gap-4">
            <li className=""><Link href="/Australia/lecturer/" >	Lecturer</Link></li>
            <li className=""><Link href="/Australia/research/" >	Research </Link></li>
            <li className=" "><Link href="/Australia/professor/" >	Professor</Link></li>
            <li><Link href="/Australia/faculty/" >	Faculty</Link></li>
          </ul>
          <li><Link href="/Australia/executive/" >	Executive</Link></li>
          <li><Link href="/Australia/admin/" >Admin</Link></li>
          <li><Link href="/Australia/hr-jobs/" >	HR</Link></li>
          <li><Link href="/Australia/student/" >	Student</Link></li>
          <li><Link href="/Australia/indigenous/">Indigenous</Link></li>
          <li><Link href="/Australia/graduate/">Graduate</Link></li>
          <li><Link href="/Australia/phd/">PhD</Link></li>
        </ul>
      </div>
      <div className=" mt-4 " >
      ...
      <h1 className="text-3xl font-normal md:text-right text-gray-400 m-0 pb-8 px-7 md:px-0 ">
            ...
            <p className="px-7">
              ...
              <div className="  " >
                <ul className=" flex flex-wrap gap-6 px-7 pb-4  text-[#f4a10c] ">
                  ...
                  <li><Link href="/gold-coast/" >	Gold Coast</Link></li>
                  <li><Link href="/canberra/" >	Canberra</Link></li>
            ...
            <h2 className="underline-full">Top Australian Universities To Work For</h2>
          <div className="cate-group section23 ">
            <div className="widget__text-block">
              <div className="faculty-container grid-cols-1 grid md:grid-cols-4 gap-4 py-2 px-7 pb-8">
                <div className="column">
                  <ul className="">
                    <li className='mb-1 mt-4'><Link href="/employers/queensland-university-of-technology-qut-/3786/" className='text-[#003463] font-bold'>Queensland University of Technology (QUT)</Link></li>
                    <ul className="innerUL">
                      <li><Link href="/jobs/QUT-lecturer/" >QUT Lecturing Jobs</Link></li>
                      <li><Link href="/jobs/QUT-research/" >QUT Research Jobs</Link></li>
                      <li><Link href="/jobs/QUT-professor/" >QUT Professorial Jobs</Link></li>
                      <li><Link href="/jobs/QUT-Executive/" >QUT Executive</Link></li>
                      <li><Link href="/jobs/QUT-Administration/" >QUT Administration</Link></li>
                      <li><Link href="/jobs/QUT-Human-Resources/" >QUT Human Resources</Link></li>
                    </ul>
                  </ul>
                </div>
                <div className="column">
                  <ul className="">
                    <li className='mb-1 mt-4'><Link href="/employers/bond-university/3785/" className='text-[#f1b821] font-bold'>Bond University</Link></li>
                    <ul className="innerUL">
                      <li><Link href="/jobs/bond-lecturer/" >Bond Lecturing Jobs</Link></li>
                      <li><Link href="/jobs/bond-research/" >Bond Research Jobs</Link></li>
                      <li><Link href="/jobs/bond-professor/" >Bond Professorial Jobs</Link></li>
                      <li><Link href="/jobs/bond-Executive/" >Bond Executive</Link></li>
                      <li><Link href="/jobs/bond-Administration/" >Bond Administration</Link></li>
                      <li><Link href="/jobs/bond-Human-Resources/" >Bond Human Resources</Link></li>
                    </ul>
                  </ul>
                </div>
                <div className="column">
                  <ul className="">
                    <li className='mb-1 mt-4'><Link href="/employers/the-university-of-adelaide/3737/" className='text-[#A51C30] font-bold'>University of Adelaide</Link></li>
                    <ul className="innerUL">
                      <li><Link href="/jobs/Adelaide/" >Adelaide Lecturing Jobs</Link></li>
                      <li><Link href="/jobs/Adelaide/" >Adelaide Research Jobs</Link></li>
                      <li><Link href="/jobs/Adelaide/" >Adelaide Professorial Jobs</Link></li>
                      <li><Link href="/jobs/Adelaide/" >Adelaide Executive</Link></li>
                      <li><Link href="/jobs/Adelaide/" >Adelaide Administration</Link></li>
                      <li><Link href="/jobs/Adelaide/" >Adelaide Human Resources</Link></li>
                    </ul>
                  </ul>
                </div>
                <div className="column">
                  <ul className="">
                    <li className='mb-1 mt-4'><Link href="/employers/university-of-western-australia/3173/" className='text-[#192847] font-bold'>University of Western Australia</Link></li>
                    <ul className="innerUL">
                      <li><Link href="/jobs/western/" >UWA Lecturing Jobs</Link></li>
                      <li><Link href="/jobs/western/" >UWA Research Jobs</Link></li>
                      <li><Link href="/jobs/western/" >UWA Professorial Jobs</Link></li>
                      <li><Link href="/jobs/western/" >UWA Executive</Link></li>
                      <li><Link href="/jobs/western/" >UWA Administration</Link></li>
                      <li><Link href="/jobs/western/" >UWA Human Resources</Link></li>
                    </ul>
                  </ul>
                </div>
              </div>
          ...
          <div id="myUniversity" class="myUniversity">
            <div class="widget__text-block1">
              <div>
              <h2 className="underline-full">Academic Jobs Australia: All University Jobs</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/act/" className='text-[#f4a10c] font-bold'>ACT</Link></li>
                    ...
                    <li className='mb-1 '><Link href="/jobs/new-south-wales/" className='text-[#f4a10c] font-bold'>New South Wales</Link></li>
                  ...
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/victoria/" className='text-[#f4a10c] font-bold'>Victoria</Link></li>
                    ...
                    <li className='mb-1 '><Link href="/jobs/tasmania/" className='text-[#f4a10c] font-bold'>Tasmania</Link></li>
                    <li><Link href="h/employers/university-of-tasmania/3867/
                                    ">The University of Tasmania</Link>
                    </li>
                  </ul>
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/queensland/" className='text-[#f4a10c] font-bold'>Queensland</Link></li>
                    <li className='text-[#003463] '><Link href="/employers/queensland-university-of-technology-qut-/3786/">Queensland
                      University of Technology (QUT)</Link>
                    </li>
                    <li className=''><Link href="/employers/bond-university/3785/
                  ...
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/south-australia/" className='text-[#f4a10c] font-bold'>South
                      Australia</Link></li>
                    ...
                    <li className='mb-1 '><Link href="/jobs/western-australia/" className='text-[#f4a10c] font-bold'>Western
                      Australia</Link></li>
