...
import europepositionsData from "@/data/europepositions.json";
...
export default function Page({ params, searchParams }) {
  ...
  console.log(params)
  let { category } = params
  console.log(europepositionsData)
  ...
  const {
    ...
    Keyword,
    content: content1,
  } = europepositionsData.find((item) => item.Name === category);
  let content;
  //console.log(Name);
  ...
  content = (
    <div className="content-grid flex-col gap-2">
      ...
      {/* <Link className="text-[#f4a10c] " href="/europepositions/">
