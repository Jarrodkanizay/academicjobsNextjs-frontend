        ...
        <div className="md:hero-content flex-col lg:flex-row mx-auto md:items-start py-12  ">
          ...
          <div>
            <p className="px-7 mb-4 mt-1">
              ...
              website where your future academic career path is one click away.
              Academic Jobs provides an extensive list of opportunities for the
              future of your career in education, carefully sectioning the top
              Higher Ed jobs to curate the best fitting position for you.
            </p>
            <p className="px-7">
              ...
              providing the best career choices possible, making us the best job
              board for higher education positions globally.
            </p>
          </div>
        </div>
      </div>
