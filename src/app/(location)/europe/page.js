...
export const metadata = {
  ...
  keywords:
    'Academic Jobs Europe. academic jobs in Europe, Europe University Jobs',
};
    ...
    <div>
      ...
      <div className="content-grid mx-auto">
          ...
          <div className="md:hero-content flex-col lg:flex-row mx-auto md:items-start py-12  ">
            ...
            <div>
              <p className="px-7 mb-4 mt-1">
                ...
                away. Academic Jobs provides an extensive list of opportunities
              ...
              <p className="px-7">
                ...
                further. At Academic Jobs, we value our customers' interests by
        ...
        <h2 className="underline-full">
          AcademicJobs Europe: All Academic Positions by university{' '}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/france/" className="text-[#f4a10c] font-bold">
                France
              </Link>
            </li>
            <li>
            ...
            <li className="mb-1 ">
              <Link href="/jobs/sweden/" className="text-[#f4a10c] font-bold">
                Sweden
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/germany/" className="text-[#f4a10c] font-bold">
                Germany
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/denmark/" className="text-[#f4a10c] font-bold">
                Denmark
              </Link>
            </li>
            <li>
            ...
            <li className="mb-1 ">
              <Link href="/jobs/belgium/" className="text-[#f4a10c] font-bold">
                Belgium
              </Link>
            </li>
            <li>
          ...
          <ul>
            ...
            <li className="mb-1 ">
              <Link href="/jobs/italy/" className="text-[#f4a10c] font-bold">
                Italy
              </Link>
            </li>
            <li>
            ...
            <li className="mb-1 ">
              <Link href="/jobs/spain/" className="text-[#f4a10c] font-bold">
                Spain
              </Link>
            </li>
            <li>
