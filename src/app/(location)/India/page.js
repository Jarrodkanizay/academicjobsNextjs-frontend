...
export const metadata = {
  ...
  keywords: 'Academic Jobs India. India university jobs, academic jobs in India, ',
};
      ...
      <div className=" mt-[10rem] " >
        <ul className="faculty-container flex flex-wrap gap-4 items-center justify-center text-gray-500 ">
          <ul className="w-full  md:w-auto flex items-center  justify-center gap-4">
            <li><Link href="/India/lecturer/" >	Lecturer</Link></li>
            <li><Link href="/India/research/" >	Research </Link></li>
            <li><Link href="/India/professor/" >	Professor</Link></li>
          </ul>
          <li><Link href="/India/executive/" >	Executive</Link></li>
          <li><Link href="/India/admin/" >Admin</Link></li>
          <li><Link href="/India/hr-jobs/" >	HR</Link></li>
          <li><Link href="/India/student/" >	Student</Link></li>
            ...
            <div class="widget__text-block1">
              <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/mumbai/" className='text-[#f4a10c] font-bold'>Mumbai</Link></li>
                    <li><Link href="/employers/indian-institute-of-technology-bombay/3844/">Indian
                      Institute of Technology Bombay</Link></li>
                  </ul>
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/chennai/" className='text-[#f4a10c] font-bold'>Chennai</Link></li>
                    <li><Link href="/employers/indian-institute-of-technology-madras/3845/">Indian
                      Institute of Technology Madras</Link></li>
                  </ul>
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/vellore/" className='text-[#f4a10c] font-bold'>Vellore</Link></li>
                    <li><Link href="/employers/vellore-institute-of-technology/3846/">Vellore
                      Institute of Technology</Link></li>
                  </ul>
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/bangalore/" className='text-[#f4a10c] font-bold'>Bangalore</Link></li>
                    <li><Link href="/employers/indian-institute-of-science/7818/">Indian
                      Institute of Science (IISc)</Link></li>
                  </ul>
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/delhi/" className='text-[#f4a10c] font-bold'>Delhi</Link></li>
