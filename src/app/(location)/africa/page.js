...
export const metadata = {
  ...
  keywords:
    'Academic Jobs Africa, academic jobs in Africa, Africa university jobs',
};
      ...
      <div className="content-grid mx-auto">
          ...
          <div className="md:hero-content flex-col lg:flex-row mx-auto md:items-start py-12  ">
            ...
            <div>
              ...
              <p className="px-7">
                ...
                your perfect academic job through our services. At Academic
        ...
        <div>
          <h2 className="underline-full">
            Academic Jobs Africa University List
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/egypt/" className="text-[#f4a10c] font-bold">
                Egypt
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/nigeria/" className="text-[#f4a10c] font-bold">
                Nigeria
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/kenya/" className="text-[#f4a10c] font-bold">
                Kenya
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/employers/moi-university/9051/">Moi University</Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/morocco/" className="text-[#f4a10c] font-bold">
                Morocco
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/ghana/" className="text-[#f4a10c] font-bold">
                Ghana
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/senegal/" className="text-[#f4a10c] font-bold">
                Senegal
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/tunisia/" className="text-[#f4a10c] font-bold">
                Tunisia
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/uganda/" className="text-[#f4a10c] font-bold">
                Uganda
              </Link>
            </li>
            <li>
