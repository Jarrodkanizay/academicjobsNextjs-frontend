...
import africapositionsData from "@/data/africapositions.json";
...
export default function Page({ params, searchParams }) {
  ...
  console.log(params)
  let { category } = params
  console.log(africapositionsData)
  ...
  const {
    ...
    Keyword,
    content: content1,
  } = africapositionsData.find((item) => item.Name === category);
  let content;
  //console.log(Name);
  ...
  content = (
    <div className="content-grid flex-col gap-2">
      ...
      {/* <Link className="text-[#f4a10c] " href="/africapositions/">
