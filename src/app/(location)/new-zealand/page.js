...
export const metadata = {
  ...
  keywords: 'Academic Jobs New Zealand. academic job in New Zealand, New Zealand university jobs',
};
export default function Page() {
 ...
 <div className=" flex flex-col items-center justify-center" >
      ...
      <h3 className="text-center ">We Are New Zealand's University Job Website</h3>
      
      <div className=" mt-[5rem] " >
        <ul className="faculty-container flex flex-wrap gap-4 items-center justify-center text-gray-400 ">
          <ul className="w-full  md:w-auto flex items-center  justify-center gap-4">
            <li><Link href="/New-Zealand/lecturer/" >	Lecturer</Link></li>
            <li><Link href="/New-Zealand/research/" >	Research </Link></li>
            <li><Link href="/New-Zealand/professor/" >	Professor</Link></li>
          </ul>
          <li><Link href="/New-Zealand/executive/" >	Executive</Link></li>
          <li><Link href="/New-Zealand/admin/" >Admin</Link></li>
          <li><Link href="/New-Zealand/hr-jobs/" >	HR</Link></li>
          <li><Link href="/New-Zealand/student/" >	Student</Link></li>
  ...
  <h1 className="text-3xl font-normal md:text-right text-gray-400 m-0 pb-8 px-7 md:px-0 ">
          <span className="md:text-6xl font-bold  md:text-right text-gray-500 pb-4 ">ACADEMIC&nbsp;JOBS New Zealand:</span> < br /> </h1>
        ...
        {/* <div className=" max-w-screen-xl mx-auto">
          ...
          <div id="myUniversity" class="myUniversity">
            <div class="widget__text-block1"> */}
              <div>
              <h2 className="underline-full">AcademicJobs New Zealand: All University Jobs by Region</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/" className='text-[#f4a10c] font-bold'>North Island</Link></li>
                  ...
                  <ul>
                    <li className='mb-1 '><Link href="/jobs/" className='text-[#f4a10c] font-bold'>South Island</Link></li>
            ...
            <h2 className="underline-full">The
