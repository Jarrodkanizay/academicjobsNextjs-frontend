...
export const metadata = {
  ...
  keywords:
    'Academic Jobs Middle East. academic jobs in Middle East, Middle East university jobs',
};
      ...
      <div className="content-grid mx-auto">
        ...
        <div>
          <h2 className="underline-full">
            AcademicJobs Middle East: University Jobs{' '}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
            ...
            <ul>
              <li className="mb-1 ">
                <Link href="/jobs/uae/" className="text-[#f4a10c] font-bold">
                  UAE
                </Link>
              </li>
              <li>
            ...
            <ul>
              ...
              <li className="mb-1 ">
                <Link href="/jobs/jordan/" className="text-[#f4a10c] font-bold">
                  Jordan
                </Link>
              </li>
              <li>
              ...
              <li className="mb-1 ">
                <Link href="/jobs/qatar/" className="text-[#f4a10c] font-bold">
                  Qatar
                </Link>
              </li>
              <li>
