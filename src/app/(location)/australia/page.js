        ...
        <div id="section" className="bg-slate-200 py-4 full-width mt-8">
          <div className="md:hero-content flex-col lg:flex-row mx-auto md:items-start py-12  ">
            ...
            {/* <div>
              ...
              <p className="px-7">
                Your on-stop-spot for all Uni Jobs in Australia, from seeking to
                recruiting, look no further. In just a few simple steps you can
                be in the running for your dream uni job!
              </p>
              <p className="px-7">
                ...
                <div className="card-body">
                  ...
                  <ul className=" p-4 pl-12 list-disc text-gray-500">
                    <li className="text-sm">
                      Great salary with outstanding additional employment
