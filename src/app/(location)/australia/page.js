  ...
  return (
    <main className="content-grid">
      ...
      <ul className="flex flex-wrap justify-center items-center md:gap-6 gap-3 px-7 pb-4 text-[#f4a10c] mx-auto">
        <li>
          <Link className="text-center" href="/melbourne"> Melbourne </Link>
        </li>
        <li>
          <Link className="text-center" href="/sydney"> Sydney</Link>
        </li>
        <li>
          <Link className="text-center" href="/brisbane">Brisbane</Link>
        </li>
        <li>
          <Link className="text-center" href="/perth"> Perth</Link>
        </li>
        <li>
          <Link className="text-center" href="/adelaide"> Adelaide</Link>
        </li>
        <li>
          <Link className="text-center" href="/canberra"> Canberra</Link>
        </li>
        <li>
          <Link className="text-center" href="/gold-coast"> Gold Coast</Link>
        </li>
        <li>
          <Link className="text-center" href="/hobart"> Hobart</Link>
        </li>
