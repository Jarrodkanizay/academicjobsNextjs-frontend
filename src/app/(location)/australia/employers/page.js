    ...
    <main>
      ...
      <div className="flex bg-base-200 shadow-xl rounded-2xl mb-12 max-w-screen-xl mx-auto mt-8 p-4 gap-8">
        ...
        <div className="w-1/3">
          <div className="grid  gap-4 mt-16 mb-4 text-gray-200">
            ...
            <div className="flex  ">
              ...
              <div className="items-center text-center">
                <p className="text-lg font-bold p-2 ">No. 1 Job Board</p>
              </div>
            </div>
            {/* Card 3 */}
            <div className="flex ">
          ...
          <Link
            href="/recruitment"
            className="btn  btn-aj ml-4 text-lg font-bold"
          >
            Post A Job
          </Link>
        </div>
      ...
      <div className="bg-gradient-to-b to-white from-orange-100 m-8 rounded-3xl  max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
          ...
          <ul>
            <li className="mb-1 text-[#f4a10c] font-bold">South Australia</li>
            <li>
            ...
            <li className="mb-1 text-[#f4a10c] font-bold">Western Australia</li>
            <li>
