  ...
  return (
    <div className=' mx-auto'>
      ...
      <div className=' max-w-screen-2xl mx-auto'>
        <h2 className="text-xl font-bold pt-4  px-10 text-[#f4a10c] ">▼ University Region Selection </h2>
        ...
        <div className="region-container bg-white">
          <h2 id="section" className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  mx-8">UNITED STATES</h2>
          ...
          <div class="region-container">
            <div>
              <h2 id="section1" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">AUSTRALIA</h2>
              <div className="bg-gradient-to-b to-white from-orange-100 m-8 rounded-3xl">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
                  ...
                  <ul>
                    ...
                    <li><Link href="/employers/bond-university/3785/
        ...
        <div>
          <h2 id="section9" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">AFRICA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7  mb-16">
              <ul>
        ...
        <div>
          <h2 id="section3" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">ASIA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section4" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">CANADA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section2" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">UNITED KINGDOM</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section5" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">SOUTH AMERICA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section6" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">NEW ZEALAND</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section7" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">MIDDLE EAST</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section8" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">INDIA</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
        ...
        <div>
          <h2 id="section4" className="text-2xl font-bold py-3 px-7 mx-8 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">EUROPE</h2>
          <div className="bg-gradient-to-b to-white from-orange-100 m-8 mb-12 rounded-3xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-16">
              <ul>
