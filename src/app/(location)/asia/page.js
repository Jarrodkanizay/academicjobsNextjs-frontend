    ...
    <div>
      ...
      <div className="content-grid mx-auto">
          ...
          <div className="md:hero-content flex-col lg:flex-row mx-auto md:items-start py-12  ">
            ...
            <div>
              <p className="px-7 mb-4 mt-1">
                ...
                Academic Jobs, you can excel your position in the university or
        ...
        <h2 className="underline-full">
          University Jobs For All Asian Countries
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
          <ul>
            ...
            <li className="mb-1 ">
              <Link href="/jobs/malaysia/" className="text-[#f4a10c] font-bold">
                Malaysia
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/china/" className="text-[#f4a10c] font-bold">
                China
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li className="mb-1 ">
              <Link href="/jobs/japan/" className="text-[#f4a10c] font-bold">
                Japan
              </Link>
            </li>
            <li>
            ...
            <li className="mb-1 ">
              <Link href="/jobs/thailand/" className="text-[#f4a10c] font-bold">
                Thailand
              </Link>
            </li>
            <li>
