...
import asiapositionsData from '@/data/asiapositions.json';
...
export async function generateMetadata({ params, searchParams }: any) {
  ...
  const {
    ...
    Keyword = '',
    content: content1 = '',
  } = asiapositionsData.find((item) => item.Name === category) || {};
...
export default function Page({ params, searchParams }: any) {
  ...
  content = (
    <div className="content-grid flex-col gap-2">
      {/* <Link className="text-[#f4a10c] " href="/asiapositions/">
