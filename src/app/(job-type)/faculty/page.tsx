    ...
    <main className="">
      ...
      <div className="regions grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mb-16 py-4 px-7 mb-8 text-left h-auto w-full text-transform: capitalize bg-gray-200">
        <ul>
          ...
          <li className="flex    ">
            <a href="/faculty/agricultural-extension/">
          ...
          <li className="flex    ">
            <a href="/faculty/international-business/">
        ...
        <ul>
          ...
          <li className="flex    ">
            <a href="/faculty/curriculum-instruction/">
          ...
          <li className="flex    ">
            <a href="/faculty/educational-psychology/">
          ...
          <li className="flex    ">
            <a href="/faculty/teacher-education-elementary-school/">
              elementary
            </a>
          </li>
          <li className="flex    ">
            <a href="/faculty/teacher-education-middle-school/">
              middle school
            </a>
          </li>
          <li className="flex    ">
          ...
          <li className="flex    ">
            <a href="/faculty/fashion-textile-design/">
        ...
        <ul>
          ...
          <li className="flex    ">
            <a href="/faculty/urban-studies-planning/">
        ...
        <ul>
          ...
          <li className="flex    ">
            <a href="/faculty/astronomy-astrophysics/">
