          ...
          <div className="container mx-auto">
            <div className="hero-content flex-col xl:flex-row gap-8 mx-auto max-w-full">
              ...
              <div>
                ...
                <p className="py-6">
                  Search jobs by university rankings worldwide and find higher
                  ed career opportunities through the best academic job board.
                  The 'find employers' page helps you explore all academic
                  positions with current job openings, at the world’s top
                  universities{' '}
                </p>
                <p className="py-2   md:flex hidden">
                  Our employer rankings help you to find amazing jobs at the
                  university of your choice. You can see details about
