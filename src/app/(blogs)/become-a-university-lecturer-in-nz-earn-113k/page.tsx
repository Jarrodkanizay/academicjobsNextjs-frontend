...
export const metadata: Metadata = {
  title: {
    absolute: 'Become a University Lecturer in New Zealand: Earn $113k!',
  },
  description:
    'How to become a university lecturer in New Zealand: Earn up to 113k. 1. Complete a bachelor degree 2. Pursue postgraduate studies 3. Gain teaching experience.',
  keywords:
...
export default function myPage() {
  const jsonLd = {
    ...
    '@type': 'NewsArticle',
    headline: 'Become a University Lecturer in New Zealand: Earn $113k!',
    image: [
          ...
          <div className="container py-16 flex flex-col lg:flex-row gap-2">
            ...
            <div className="flex-shrink-0 pb-8">
              <Image
                ...
                alt="Considering becoming a university lecturer in New Zealand? Learn about the rewarding career path, growth opportunities, required skills, and salary expectations"
        ...
        <div className="lg:flex gap-10">
          <div className="grow mb-16">
            ...
            <section className="my-16">
              <p>
                Are you ready to become a university lecturer in New Zealand?{' '}
            ...
            <HeroCard
              ...
              para1="The average salary for a university lecturer in New Zealand is approximately NZD 115,000 per year. The job market is looking promising, with a projected growth rate of 16.6% over the next few years​. Entry-level lecturers can expect to earn around NZD 79,970, while those with more experience might earn upwards of NZD 140,000​."
              imagePath="/talent-pool/dynamic-talent-match-making.jpg"
              alt="University lecturer salary in New Zealand: average NZD 113,000 per year, with entry-level at NZD 79,970 and experienced up to NZD 130,000."
            ...
            <HeroCard
              ...
              alt="New Zealandn university lecturers balancing teaching, research, and administrative tasks, collaborating, and attending conferences."
              imagePosition="right"
              btnLink="/lecturer"
            ...
            <section>
              ...
              <p className="text-slate-500 font-normal text-2xl">
                ...
                lecturer positions, earning as high as NZD 150k a year. Here are
                ...
                <ul className="mb-4">
                  <li>
                    ...
                    <a href="/lecturer" className="link link-aj">
                      university lecturer job openings in New Zealand
                    </a>{' '}
            ...
            <section>
              ...
              <p className="text-slate-500 font-normal text-2xl mb-8">
                Becoming a university lecturer in New Zealand is a fulfilling
          ...
          <div className="lg:min-w-[400px]">
            {/* @ts-ignore */}
            <SearchResults4 q={{ q: 'lecturer', l: 'New Zealand' }} />
          </div>
        </div>
      </main>
      <script
