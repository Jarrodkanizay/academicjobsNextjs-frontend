...
export default function myPage() {
  const jsonLd = {
    ...
    '@type': 'NewsArticle',
    headline: 'How to Excel as a Research Assistant in New Zealand',
    image: [
      ...
      <main className="content-grid">
          ...
          <div className="container py-16 flex flex-col lg:flex-row gap-2">
            <div className="flex flex-col justify-center">
              ...
              <p>
                ...
                in New Zealand? You’re in the right place! This exciting
        ...
        <section className="lg:flex mb-16">
          ...
          <div>
            ...
            <p>
              A research assistant in New Zealand supports various research
        ...
        <div className="lg:flex gap-10">
          <div className="grow mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                ...
                >
                  <p className="text-left">
                    ...
                    start as a research assistant in New Zealand, a bachelor’s
            ...
            <section>
              ...
              <p>
                The salary for a research assistant in New Zealand varies
            ...
            <section className="my-16">
              <p>
                Are you ready to become a research assistant in New Zealand?{' '}
            ...
            <section>
              ...
              <p className="mb-6">
                Here’s how to make a strong start as a research assistant in New
                Zealand:
              </p>
              <div className="card bg-white p-6 rounded-lg shadow-lg relative mb-6">
                <div className="card-content">
                ...
                <ul className="mb-4">
                  <li>
                    ...
                    <a href="/research" className="link link-aj">
                      research assistant job openings in New Zealand
                    </a>{' '}
            ...
            <section>
              ...
              <p className="text-slate-500 font-normal text-xl mb-8">
                Starting a career as a research assistant in New Zealand is a
            ...
            <section>
              ...
              >
                How to become a university lecturer in New Zealand
              </a>
            </section>
          </div>
          <div className="lg:min-w-[400px]">
            {/* @ts-ignore */}
            {/* <SearchResults2 q={{ q: 'research', l: 'New Zealand' }} /> */}
