...
export const metadata: Metadata = {
  title: {
    absolute: 'jobs at boston university',
  },
  description:
    'To find out more about the jobs at boston university available in higher education, browse our list of current  jobs at boston university vacancies on this page. ',
  keywords: ' jobs at boston university',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              jobs at boston university{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            jobs at boston university has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, jobs at boston university has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at jobs at boston university
            </Link>
            </div>
