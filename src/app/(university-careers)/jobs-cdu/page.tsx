...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the jobs cdu available in higher education, browse our list of current  jobs cdu vacancies on this page. ',
  keywords: ' jobs cdu',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            jobs cdu has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, jobs cdu has advice on the business world and accomplishing your objectives. 
