...
export const metadata: Metadata = {
  title: {
    absolute: 'ecu university jobs',
  },
  description:
    'To find out more about the ecu university jobs available in higher education, browse our list of current  ecu university jobs vacancies on this page. ',
  keywords: ' ecu university jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            ecu university jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, ecu university jobs has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at ecu university jobs
            </Link>
            </div>
