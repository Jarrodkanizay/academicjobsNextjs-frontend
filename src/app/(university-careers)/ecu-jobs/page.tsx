...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the ecu jobs available in higher education, browse our list of current  ecu jobs vacancies on this page. ',
  keywords: ' ecu jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            ecu jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, ecu jobs has advice on the business world and accomplishing your objectives. 
