...
export const metadata: Metadata = {
  title: {
    absolute: 'jobs at qut',
  },
  description:
    'To find out more about the jobs at qut available in higher education, browse our list of current  jobs at qut vacancies on this page. ',
  keywords: ' jobs at qut',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            jobs at qut has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, jobs at qut has advice on the business world and accomplishing your objectives. 
