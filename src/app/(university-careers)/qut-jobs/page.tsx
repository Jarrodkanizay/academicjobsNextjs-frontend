...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the qut jobs available in higher education, browse our list of current  qut jobs vacancies on this page. ',
  keywords: ' qut jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            qut jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, qut jobs has advice on the business world and accomplishing your objectives. 
