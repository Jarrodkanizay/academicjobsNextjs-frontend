...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the jobs qut available in higher education, browse our list of current  jobs qut vacancies on this page. ',
  keywords: ' jobs qut',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            jobs qut has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, jobs qut has advice on the business world and accomplishing your objectives. 
