...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the cdu jobs available in higher education, browse our list of current  cdu jobs vacancies on this page. ',
  keywords: ' cdu jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            cdu jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, cdu jobs has advice on the business world and accomplishing your objectives. 
