...
export const metadata: Metadata = {
  title: {
    absolute: 'brandeis university careers',
  },
  description:
    'To find out more about the brandeis university careers available in higher education, browse our list of current  brandeis university careers vacancies on this page. ',
  keywords: ' brandeis university careers',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              brandeis university careers{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            brandeis university careers has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, brandeis university careers has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at brandeis university careers
            </Link>
            </div>
