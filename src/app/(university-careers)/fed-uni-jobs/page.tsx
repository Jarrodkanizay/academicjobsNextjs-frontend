...
export const metadata: Metadata = {
  title: {
    absolute: 'fed uni jobs',
  },
  description:
    'To find out more about the fed uni jobs available in higher education, browse our list of current  fed uni jobs vacancies on this page. ',
  keywords: ' fed uni jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            fed uni jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, fed uni jobs has advice on the business world and accomplishing your objectives. 
