        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              ...
              journey of growth and fulfillment with monash university careers.
              With a commitment to excellence and a supportive community, monash
              university careers Careers empowers you to make a meaningful
              impact while advancing your professional aspirations.
            </p>
            <p className="font-bold">
              Elevate your career to new heights. Dare to dream, and let monash
              university careers be your launchpad to success.
            </p>
            {/* <Link
