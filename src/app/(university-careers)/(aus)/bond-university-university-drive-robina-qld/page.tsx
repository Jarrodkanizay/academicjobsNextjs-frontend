...
export const metadata: Metadata = {
  title: {
    absolute: 'bond university university drive robina qld',
  },
  description:
    'To find out more about the bond university university drive robina qld available in higher education, browse our list of current bond university university drive robina qld vacancies on this page. ',
  keywords: 'bond university university drive robina qld',
};
          ...
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              <span className="text-5xl font-bold text-amber-500">
                bond university university drive robina qld{' '}
              </span>
              <br />
            </h1>
