...
export const metadata: Metadata = {
  title: {
    absolute: 'macquarie uni jobs',
  },
  description:
    'To find out more about the macquarie uni jobs available in higher education, browse our list of current macquarie uni jobs vacancies on this page. ',
