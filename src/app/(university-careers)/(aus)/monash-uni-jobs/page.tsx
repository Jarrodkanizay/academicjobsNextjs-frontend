...
export const metadata: Metadata = {
  title: {
    absolute: 'monash uni jobs',
  },
  description:
    'To find out more about the monash uni jobs available in higher education, browse our list of current monash uni jobs vacancies on this page. ',
  keywords: 'monash uni jobs',
};
