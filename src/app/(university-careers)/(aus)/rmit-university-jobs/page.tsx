...
export const metadata: Metadata = {
  title: {
    absolute: 'rmit university jobs',
  },
  description:
    'To find out more about the rmit university jobs available in higher education, browse our list of current rmit university jobs vacancies on this page. ',
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            Greetings from the rmit university jobs page, which serves as your entry point to all things higher education. Get unparalleled opportunities for both professional and personal development by interacting with the visionaries and leaders reshaping the future. 
