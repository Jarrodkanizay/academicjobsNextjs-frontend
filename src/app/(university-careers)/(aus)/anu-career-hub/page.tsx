...
export const metadata: Metadata = {
  title: {
    absolute: 'anu career hub',
  },
  description:
    'To find out more about the anu career hub available in higher education, browse our list of current  Panu career hub vacancies on this page. ',
  keywords: ' anu career hub',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            anu career hub has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, anu career hub has advice on the business world and accomplishing your objectives. 
