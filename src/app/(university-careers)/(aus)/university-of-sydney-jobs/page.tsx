...
export const metadata: Metadata = {
  title: {
    absolute: 'university of sydney jobs',
  },
  description:
    'To find out more about the university of sydney jobs available in higher education, browse our list of current university of sydney jobs vacancies on this page. ',
  keywords: 'university of sydney jobs',
};
