        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              Discover fulfilling career opportunities at anu jobs canberra,
              where innovation and impact meet. Join a diverse group of people
              who are dedicated to eradicating obstacles and shaping the future.
              Look at jobs in a variety of industries where you can develop your
              skills and have a voice.
            </p>
            <p className="font-bold">
