...
export const metadata: Metadata = {
  title: {
    absolute: 'monash uni careers',
  },
  description:
    'To find out more about the monash uni careers available in higher education, browse our list of current  monash uni careers vacancies on this page. ',
  keywords: ' monash uni careers',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            monash uni careers has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, monash uni careers has advice on the business world and accomplishing your objectives. 
