...
export const metadata: Metadata = {
  title: {
    absolute: 'duquesne university employment',
  },
  description:
    'To find out more about the duquesne university employment available in higher education, browse our list of current  duquesne university employment vacancies on this page. ',
  keywords: ' duquesne university employment',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              duquesne university employment{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            duquesne university employment has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, duquesne university employment has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at duquesne university employment
            </Link>
            </div>
