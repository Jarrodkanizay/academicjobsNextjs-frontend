...
export const metadata: Metadata = {
  title: {
    absolute: 'usc university jobs',
  },
  description:
    'To find out more about the usc university jobs available in higher education, browse our list of current  usc university jobs vacancies on this page. ',
  keywords: ' usc university jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            usc university jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, usc university jobs has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at usc university jobs
            </Link>
            </div>
