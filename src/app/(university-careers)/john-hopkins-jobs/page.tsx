      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            Explore rewarding employment options at Johns Hopkins University, where influence and innovation collide. Become a part of a varied community committed to breaking down barriers and influencing the future. Investigate positions in several fields where your abilities flourish and your opinions are valued. 
