...
export const metadata: Metadata = {
  title: {
    absolute: 'edith cowan jobs',
  },
  description:
    'To find out more about the edith cowan jobs available in higher education, browse our list of current  edith cowan jobs vacancies on this page. ',
  keywords: ' edith cowan jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            edith cowan jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, edith cowan jobs has advice on the business world and accomplishing your objectives. 
