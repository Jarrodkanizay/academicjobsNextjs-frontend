...
export const metadata: Metadata = {
  title: {
    absolute: 'usc job opportunities',
  },
  description:
    'To find out more about the usc job opportunities available in higher education, browse our list of current  usc job opportunities vacancies on this page. ',
  keywords: ' usc job opportunities',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              usc job opportunities{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            usc job opportunities has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, usc job opportunities has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at usc job opportunities
            </Link>
            </div>
