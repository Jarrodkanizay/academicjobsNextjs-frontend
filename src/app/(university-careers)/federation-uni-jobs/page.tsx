...
export const metadata: Metadata = {
  title: {
    absolute: 'federation uni jobs',
  },
  description:
    'To find out more about the federation uni jobs available in higher education, browse our list of current  federation uni jobs vacancies on this page. ',
  keywords: ' federation uni jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            federation uni jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, federation uni jobs has advice on the business world and accomplishing your objectives. 
      ...
      <section className="jobs_grid job_post_search_container">
        ...
        <div className="listings_panel">
          <div className="listings_content">
            ...
            <SearchResults q={{ q: 'federation' || 0 }} />
          </div>
        </div>
      </section>
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at federation uni jobs
            </Link>
            </div>
