...
export const metadata: Metadata = {
  title: {
    absolute: 'jobs at cdu',
  },
  description:
    'To find out more about the jobs at cdu available in higher education, browse our list of current  jobs at cdu vacancies on this page. ',
  keywords: ' jobs at cdu',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            jobs at cdu has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, jobs at cdu has advice on the business world and accomplishing your objectives. 
