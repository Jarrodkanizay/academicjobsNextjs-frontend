...
export const metadata: Metadata = {
  title: {
    absolute: 'tufts university careers',
  },
  description:
    'To find out more about the tufts university careers available in higher education, browse our list of current  tufts university careers vacancies on this page. ',
  keywords: ' tufts university careers',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            tufts university careers has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, tufts university careers has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
            ...
            >
              Careers at tufts university careers
            </Link>
            </div>
