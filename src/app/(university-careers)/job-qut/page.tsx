...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the job qut available in higher education, browse our list of current  job qut vacancies on this page. ',
  keywords: ' job qut',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            job qut has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, job qut has advice on the business world and accomplishing your objectives. 
