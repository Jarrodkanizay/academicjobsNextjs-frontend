...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the qut job available in higher education, browse our list of current  qut job vacancies on this page. ',
  keywords: ' qut job',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            qut job has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, qut job has advice on the business world and accomplishing your objectives. 
