...
export const metadata: Metadata = {
  title: {
    absolute: 'yale university jobs',
  },
  description:
    'To find out more about the yale university jobs available in higher education, browse our list of current  yale university jobs vacancies on this page. ',
  keywords: ' yale university jobs',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              yale university jobs has countless options and guidance from
              discovery to achievement. Whether you're just starting out or
              looking to grow, yale university jobs has advice on the business
