  ...
  return (
    <main className="">
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              university of riverside jobs has countless options and guidance
              from discovery to achievement. Whether you're just starting out or
              looking to grow, university of riverside jobs has advice on the
      ...
      <div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
        <Link
          href="/employers/university-of-california-riverside/3268"
