...
export const metadata: Metadata = {
  title: {
    absolute: 'university of riverside jobs',
  },
  description:
    'To find out more about the university of riverside jobs available in higher education, browse our list of current  university of riverside jobs vacancies on this page. ',
  keywords: ' university of riverside jobs',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              university of riverside jobs{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            university of riverside jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, university of riverside jobs has advice on the business world and accomplishing your objectives. 
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
              href="https://www.academicjobs.com/employers/university-of-california-riverside/3268"
              className="btn  btn-aj text-lg font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen"
            >
              Careers at university of riverside jobs
            </Link>
            </div>
