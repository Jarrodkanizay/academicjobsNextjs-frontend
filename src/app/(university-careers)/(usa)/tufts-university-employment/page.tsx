...
export const metadata: Metadata = {
  title: {
    absolute: 'tufts university employment',
  },
  description:
    'To find out more about the tufts university employment available in higher education, browse our list of current tufts university employment vacancies on this page. ',
  keywords: 'tufts university employment',
};
