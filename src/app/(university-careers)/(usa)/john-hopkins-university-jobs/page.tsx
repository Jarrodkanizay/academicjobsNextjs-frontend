...
export const metadata: Metadata = {
  ...
  description:
    'To find out more about the John Hopkins University Jobs available in higher education, browse our list of current John Hopkins University Jobs vacancies on this page. ',
  keywords: 'John Hopkins University Jobs',
};
          ...
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              <span className="text-5xl font-bold text-amber-500">
                John Hopkins Careers{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            Discover exciting career opportunities at Johns Hopkins University, where innovation meets impact. Join a diverse community dedicated to pushing boundaries and shaping the future. Explore roles across disciplines, where your talents thrive and your ideas matter. 
