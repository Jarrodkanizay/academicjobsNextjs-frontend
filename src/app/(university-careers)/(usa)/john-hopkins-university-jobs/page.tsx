        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              Discover exciting career opportunities at Johns Hopkins
              University, where innovation meets impact. Join a diverse
              community dedicated to pushing boundaries and shaping the future.
              Explore roles across disciplines, where your talents thrive and
              your ideas matter.
            </p>
            <p className="font-bold">
