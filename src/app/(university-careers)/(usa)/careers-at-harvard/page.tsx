        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              Welcome to Harvard University's career page, your gateway to all
              higher education opportunities. Discover unmatched prospects for
              personal and professional growth, connecting with leaders and
