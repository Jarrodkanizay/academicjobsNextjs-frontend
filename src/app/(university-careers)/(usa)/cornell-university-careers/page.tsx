...
export const metadata: Metadata = {
  title: {
    absolute: 'Cornell university careers',
  },
  description:
    'To find out more about the Cornell university careers available in higher education, browse our list of current Cornell university careers vacancies on this page. ',
  keywords: 'Cornell university careers',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            Cornell university careers has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, Cornell university careers has advice on the business world and accomplishing your objectives. 
