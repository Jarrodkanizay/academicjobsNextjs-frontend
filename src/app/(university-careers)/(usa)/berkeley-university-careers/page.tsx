        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              Berkeley's vast resources and expert support allow you to explore
              many options and be guided from exploration to achievement.
              Whether you're just starting out or looking to develop, Berkeley
              is the partner you should turn to for advice on the business world
