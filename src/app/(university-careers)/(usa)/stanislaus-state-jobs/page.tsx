  ...
  return (
    <main className="">
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              stanislaus state jobs has countless options and guidance from
              discovery to achievement. Whether you're just starting out or
              looking to grow, stanislaus state jobs has advice on the business
              world and accomplishing your objectives.
            </p>
      ...
      <div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
        <Link
          href="/employers/california-state-university-stanislaus/3414"
