...
export const metadata: Metadata = {
  title: {
    absolute: 'stanislaus state jobs',
  },
  description:
    'To find out more about the stanislaus state jobs available in higher education, browse our list of current  stanislaus state jobs vacancies on this page. ',
  keywords: ' stanislaus state jobs',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              stanislaus state jobs{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            stanislaus state jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, stanislaus state jobs has advice on the business world and accomplishing your objectives. 
      ...
      <section className="jobs_grid job_post_search_container">
        ...
        <div className="listings_panel">
          <div className="listings_content">
            ...
            <SearchResults q={{ q: 'stanislaus' || 0 }} />
          </div>
        </div>
      </section>
...
<div className="font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen mt-8 ml-40">
      <Link
              href="https://www.academicjobs.com/employers/california-state-university-stanislaus/3414"
              className="btn  btn-aj text-lg font-bold item-center justify-center text-center md:mb-0 mb-2 mx-auto max-w-screen"
            >
              Careers at stanislaus state jobs
            </Link>
            </div>
