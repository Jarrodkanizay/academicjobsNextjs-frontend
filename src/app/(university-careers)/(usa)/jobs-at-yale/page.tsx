...
export const metadata: Metadata = {
  title: {
    absolute: 'jobs at yale',
  },
  description:
    'To find out more about the jobs at yale available in higher education, browse our list of current  jobs at yale vacancies on this page. ',
  keywords: ' jobs at yale',
};
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-bold">
              jobs at yale has countless options and guidance from discovery to
              achievement. Whether you're just starting out or looking to grow,
              jobs at yale has advice on the business world and accomplishing
              your objectives.
            </p>
