...
export const metadata: Metadata = {
  title: {
    absolute: 'notre dame jobs',
  },
  description:
    'To find out more about the notre dame jobs available in higher education, browse our list of current  notre dame jobs vacancies on this page. ',
  keywords: ' notre dame jobs',
};
      ...
      >
        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            ...
            notre dame jobs has countless options and guidance from discovery to achievement. Whether you're just starting out or looking to grow, notre dame jobs has advice on the business world and accomplishing your objectives. 
