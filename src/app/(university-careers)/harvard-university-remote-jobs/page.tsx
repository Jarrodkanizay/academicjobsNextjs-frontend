        ...
        <div className="hero-content text-white ">
          <div className="max-w-2xl mx-auto">
            <h1 className="mb-5  text-white md:text-2xl text-2xl font-normal">
              ...
              Harvard University remote jobs{' '}
              </span>
              <br />
            </h1>

            <p className="font-bold">
            Greetings from the Harvard University career page, which serves as your entry point to all things higher education. Get unparalleled opportunities for both professional and personal development by interacting with the visionaries and leaders reshaping the future. 
