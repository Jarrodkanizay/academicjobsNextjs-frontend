      ...
      <main className="container">
        ...
        <div className="prose text mt-8 grid grid-cols-3 gap-4 ">
          ...
          <p className="mt-4">
            ...
            and they continued to operate on very old, outdated technology. They
            therefore have created the best academic job platform in the world
            today... making it easier for candidates to search for jobs, compare
            offers, and communicate with employers. They have also provided
            employers with a cost-effective and user-friendly way to advertise
          ...
          <p className="mt-4">
            ...
            users from all over the world, 10,000 active job listings, and 500
            partner institutions across 50 countries. AcademicJobs.com lists all
            disciplines and academic specialties in all levels of academia, from
            humanities and social sciences to STEM and health sciences, from PhD
          ...
          <p className="mt-4">
            ...
            user-friendly tools, and the most professional and personalized
            service. We are also passionate about supporting the academic
