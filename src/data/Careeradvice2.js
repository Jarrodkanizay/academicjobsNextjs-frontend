...
const Careeradvice2 = () => {
  return (
    <div className="max-w-screen-xl mx-auto ">
            ...
            <div className="widget__text-block">
              ...
              <div className="column">
                  ...
                  <li className="mb-1 mt-4">
                      <Link to="/academic-hub/find-student-jobs-on-your-university-campus/" className="text-[#f4a10c] ">
                ...
                <div className="column">
                  <ul className="">
                    ...
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/seek-all-qut-university-careers-here/" className="text-[#f4a10c] ">
                      Seek all QUT University Careers Here
                      </Link>
                    </li>
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/seek-all-qut-university-jobs-here/" className="text-[#f4a10c] ">
                ...
                <div className="column">
                  <ul className="">
                    ...
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/seek-all-bond-university-jobs-here/" className="text-[#f4a10c] ">
                ...
                <div className="column">
                  <ul className="">
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/start-your-career-at-harvard-university/" className="text-[#f4a10c] ">
                      Start your Career at Harvard University 
                      </Link>
                    </li>
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/seek-all-harvard-university-jobs-here/" className="text-[#f4a10c] ">
                ...
                <div className="column">
                  <ul className="">
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/seek-all-ucla-jobs-here/" className="text-[#f4a10c] ">
                      Seek all UCLA Jobs Here
                      </Link>
                    </li>
                    <li className="mb-1 mt-4">
                      <Link to="/academic-hub/start-you-career-at-ucla/" className="text-[#f4a10c]">
      ...
      <div className="w-ful  mx-auto  bg-[#f4ac10] border-[0.65rem] rounded-full md:my-2 md:mb-4  border-[#f4a10c] shadow-xl">
