export const regionData = [
...

  {
    ...
    Description:
      "A bachelor's degree or above in a relevant field, such human resources management, is required to be eligible for Human Resources Academic Jobs New Zealand.",
