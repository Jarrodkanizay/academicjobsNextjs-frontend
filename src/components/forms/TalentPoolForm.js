...
const TalentPoolForm = ({
    ...
    const fetchTalentPoolDetails = async () => {
      try {
        ...
        if (talentPool) {
          ...
          for (const key in talentPool) {
            if (talentPool.hasOwnProperty(key)) {
              setValue(key, talentPool[key]);
            }
          }
        }
        setLoaded(true);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await BaseApi.post('/createOrUpdateUserTalentPoolDetailsByID', data);
  ...
  return (
    ...
    >
      ...
      <h2 className=" mt-10 mb-6">{academicDetailsHeading}</h2>
        ...
        <div className="form-control">
          <label className="label cursor-pointer">
            <input
              tabIndex={6}
              type="checkbox"
              {...register("interestCollaboration")}
        ...
        <div className="form-control">
          <label className="label cursor-pointer">
            <input
              tabIndex={8}
              type="checkbox"
              {...register("interestMediaVisibilty")}
              className="checkbox checkbox-warning"
            />
        ...
        <div className="form-control">
          <label className="label cursor-pointer">
            <input
              tabIndex={9}
              type="checkbox"
              {...register("interestCareerProgression")}
              className="checkbox checkbox-warning"
            />
        ...
        <div className="form-control">
          <label className="label cursor-pointer">
            <input
              tabIndex={11}
              type="checkbox"
              {...register("interestIndustryPartner")}
              className="checkbox checkbox-warning"
            />
      ...
      {academicAwardsHeading !== '' && (
        <>
          <h2 className=" mt-10 mb-6">{academicAwardsHeading}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Institution */}
