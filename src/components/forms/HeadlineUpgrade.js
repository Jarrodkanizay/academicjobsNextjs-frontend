  ...
  if (mutation.isSuccess) {
    ...
    content = (
      <main className=" content-grid">
        <p className='text-xl font-bold text-gray-500'>Great, let’s get this job fully seen by our amazing audience.<br/> 
This is currently a ‘Headline Job’ only, but in 60 seconds, it will be a ‘Priority Listing’.
</p>
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div>
            <h3 className={`${textColor} mb-4`}>
              Let's do this... <br/> We have the full job 
ready to go,
and this form takes
ONLY 60 SECONDS!!!
            ...
            <div className="prose text-gray-500">
              <p className="mt-4">
              Fun Fact:  The average time to Post a Job and fill out a form 
on the major Job Seeking platforms is 9 min or more. 
At AcademicJobs.com, we make your life easier and 
save you time …
              ...
              <ul>
                ...
                <li>
                	AJ QUICK POSTS = ^ VIEWS  = + APLICANTS 
                </li>
              </ul>
            </div>
          </div>
