    ...
    <>
            ...
            <div className="hero-content flex-col lg:flex-row gap-8">
              ...
              <div>
                <h1 className="text-3xl font-bold text-aj">
                  Join Australia's No. 1 Academic Job Board & Community
                </h1>
                <h4 className="">
                ...
                <p className="py-6">
                  Australia's HR professionals love how simple and affordable it
                  is to post jobs that target the best local & global talent. We
                  understand the importance of finding the right talent, and we
                  go above and beyond to help you achieve this.
                </p>
                <Link
      ...
      <section className="container mx-auto px-4 mt-12">
        <h2 className="text-center mb-4">
          Connect with Australia's Academic Elite on the Premier Job Board
        </h2>
        <div className="text-col-2">
          <p className="max-w-xl mx-auto">
            Leverage the power of Australia's No. 1 Academic Job Board for
          ...
          <p className="max-w-xl mx-auto">
            ...
            cutting-edge AI technology, we provide a seamless and cost-effective
            recruitment experience, ensuring you attract the right candidates
            effortlessly.
          </p>
        </div>
          ...
          <div className="card bg-slate-100 shadow-xl">
            ...
            <div className="card-body items-center text-center">
              <h2 className="card-title">
                Australia's Leading Academic Job Board
              </h2>
              <p>
                Connect with Australia's top academic talent on the nation's No.
                1 Academic Job Board. Posting jobs is simple and affordable,
                targeting both local and global candidates.{' '}
                <span className="hidden">
                  We specialise in matching premier academic professionals with
                  your specific needs, ensuring you find the right talent every
                  time.
                </span>
              </p>
            </div>
        ...
        <div className="card card-side bg-slate-100 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="card-body w-full">
            ...
            <p className="max-w-screen-sm">
              ...
              By bringing back genuine customer service and leveraging the power
              of AI, we create a pleasurable customer experience that ALL modern
              platforms have lost. Quickly post jobs for executive jobs in
              higher education, academic jobs, staff jobs and all university
              staff roles.
            </p>
      ...
      <div className="bg-sky-100 mb-8 mt-16 py-8 px-4">
        <div className="container mx-auto">
          ...
          <p className="mb-4 text-center max-w-[500px] mx-auto">
            Academic Jobs doesn't just find academics, we specialise in finding
            the best candidates for Admin/Support roles in academia, Executive
            positions and HR specialists
          </p>
          {/* </div> */}
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 mt-12">
        ...
        <div className="card card-side bg-slate-100 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="card-body w-full">
            ...
            <p className="max-w-screen-sm">
              With the most comprehensive Academic Talent Pool, you can identify
              the most sought-after candidates and make informed decisions about
        ...
        <div className="card card-side bg-sky-50 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="card-body w-full">
            ...
            <p className="max-w-screen-sm">
              Our tools make it easy to list and manage your job posts, find top
              candidates and improve talent acquisition. But most importantly,
      ...
      <div className="bg-teal-100 mb-8 mt-16 py-8 px-4">
        <div className="container mx-auto">
          ...
          <div className="text-col-2">
            <p className="mb-4">
              <blockquote>
                Discover the Ease of Academic Recruitment with Australia's
                Leading Job Board
              </blockquote>
              Choosing Academic Jobs means partnering with Australia's foremost
              ...
              destination for academic recruitment, we cater specifically to the
              needs of HR professionals in the academic sector, offering an
              effortless platform to post job vacancies.
            </p>
            <p className="mb-4">
              Understanding the critical importance of finding the right talent
              drives us to provide exceptional service, ensuring your job
              postings effectively target and attract local and global
              candidates. With options like unlimited job postings for two or
              three months at competitive prices, we make it feasible and highly
              advantageous for you to connect with the best minds in academia.
              Academic Jobs stands out for its extensive reach and commitment to
              making recruitment a smooth and rewarding experience.
            </p>
            <blockquote>
            ...
            <p className="mb-4">
              ...
              integrating genuine customer service with advanced AI technology,
              our platform offers a fresh and efficient approach to connecting
              with qualified academics worldwide. This synergy of technology and
              human touch results in a pleasurable and effective recruitment
              process, something we pride ourselves on in an era where true
              customer service has become a rarity.
            </p>
            <p className="mb-4">
              Our platform is designed to minimise your job listing costs while
              maximising results and recruiter satisfaction. With access to our
              comprehensive academic talent pool, you can make informed hiring
              decisions and identify the most suitable candidates who will be a
            ...
            <p className="mb-4">
              ...
              not just for our prestigious status but for an unmatched level of
              customer service and support, ensuring you find the right academic
              talent effortlessly and efficiently.
            </p>
          </div>
        </div>
      </div>
